...
.transcript{max-height:640px;overflow-y:auto;padding:4px 12px 4px 4px;background:var(--card);border:1px solid var(--line-soft);border-radius:10px}
.turn{display:flex;gap:10px;margin-bottom:10px;font-size:13.5px;line-height:1.5}
